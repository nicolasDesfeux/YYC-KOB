...
public class PlayerApiController implements PlayerApi {
    ...
    public ResponseEntity<Void> deletePlayer(@ApiParam(value = "player id to delete",required=true) @PathVariable("playerId") Long playerId,@ApiParam(value = "" ) @RequestHeader(value="api_key", required=false) String apiKey) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<List<Pet>> findPlayerByName(@NotNull @ApiParam(value = "Name to search for", required = true) @Valid @RequestParam(value = "name", required = true) String name) {
        String accept = request.getHeader("Accept");
    ...
    public ResponseEntity<Pet> getPlayerById(@ApiParam(value = "ID of player to return",required=true) @PathVariable("playerId") Long playerId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/xml")) {
            try {
    ...
    public ResponseEntity<Void> updatePlayerWithForm(@ApiParam(value = "ID of player that needs to be updated",required=true) @PathVariable("playerId") Long playerId,@ApiParam(value = "Updated name of the player") @RequestParam(value="name", required=false)  String name) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
